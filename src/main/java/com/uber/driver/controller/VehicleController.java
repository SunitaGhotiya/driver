...
public class VehicleController {
    ...
    public ResponseEntity<DriverVehicle> getVehicle(@PathVariable("id") String driverId){
    ...
    public ResponseEntity<DriverVehicle> updateVehicle(@PathVariable("id") String driverId, @RequestBody DriverVehicle driverVehicle){
